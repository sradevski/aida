...
const LearnHow = props => (
  <Block background="light">
    {[
      {
        content:
          'Aida is a data and endpoint modeling tool. You can document your data models from different parts of the system in one place and share commonalities between them, representing a single source of truth. It allows you to unify how your data models and endpoints are defined, with all the necessary metadata being co-located. <br/><br/> Once everything is defined and ready to be used, the possibilities are endless. You can mock your API on your client-side for truly independent frontend development, generate dummy data for your development database, generate API documentation for your backend, and generate validation and schemas, all done automatically. For more information, head to our **[getting started](docs/getting-started/introduction.html)** guide',
